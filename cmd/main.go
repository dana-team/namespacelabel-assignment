...
import (
	...
	"github.com/dvirgilad/namespacelabel-assignment/internal/controller"
...
func main() {
	...
	flag.StringVar(&protectedPrefixes, "protected-prefixes", "kubernetes.io,openshift.io", "comma seperated string of label prefixes to not allow")
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "aa542794.dvir.io",
	})
	if err != nil {
